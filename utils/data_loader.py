...
train_valid_user_set = defaultdict(list)

has_valid = ['yelp', 'movielens', 'book']
...
def statistics(train_data, valid_data, test_data):
    ...
    for u_id, i_id in train_data:
        ...
        train_valid_user_set[int(u_id)].append(int(i_id))
...
def load_data(model_args):
    ...
    user_dict = {
        ...
        'valid_user_set': valid_user_set if args.dataset in has_valid else None,
        'train_valid_user_set': train_valid_user_set,
